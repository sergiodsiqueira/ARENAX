...
class UnitOfWork(Protocol):
    ...
    async def add_equipment(self, space_id: UUID, kind: str, external_id: str, description: str, configuration: dict) -> UUID: ...
    async def get_equipment(self, equipment_id: UUID, *, lock: bool = False) -> dict | None: ...
    async def update_equipment(
        self, equipment_id: UUID, space_id: UUID, kind: str, external_id: str, description: str, configuration: dict, administrative_status: str
    ) -> dict: ...
    ...
    async def revoke_password_reset_tokens(self, user_id: UUID, now: datetime) -> None: ...
    async def add_user(
